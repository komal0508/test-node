...
module.exports = function(app) {
  ...
  */
 app.post("/api/get-attendance-by-year-&-id-filter", (req, res, next) => {
    ...
    WHERE EXTRACT(YEAR FROM attendances.date) = ${req.body.year} and attendances.emp_id = '${req.body.empId}'`, { type: sequelize.QueryTypes.SELECT })
    .then((response) => {
