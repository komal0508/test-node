...
const sendMail = (email, url) => {
  const mailOptions = {
    ...
    to: email,
    subject: 'Mahi Attendance: Verify your email',
    html: `
...
//     from: 'Cryptoflip',
//     to: email,
//     subject: 'Cryptoflip: Thank you for Registration',
//     html: `
//         <table width="100%" bgcolor="#ffffff" border="0" cellpadding="10" cellspacing="0" style="
//             background:  #f3f3f3;
//         ">
...
//   secure: true, // use SSL
//   auth: {
//     user: 'akhanna@innow8apps.com',
//     pass: 'abhi-1234567890',
//   },
// });
...
//     from: 'kgoyal@innow8apps.com',
//     to: email,
//     subject: 'Cryptoflip: Verify your email',
//     html: `
...
//                                   <img height="30" width="130" src="https://gallery.mailchimp.com/4b8bd780d4a9c6b85090d2d2d/images/8749d251-43fd-4c72-9f2c-551bd8238fde.png" alt="CryptoFlip" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;border: none;font-size: 14px;font-weight: bold;height: auto;line-height: 100%;text-transform: capitalize;">
//                                 </td>
//                                 <td width="24" style="width: 24px;line-height: 0px;font-size: 0px;border-collapse: collapse;">&nbsp;</td>
//                               </tr>
//                               <tr>
...
//                                 <a href="https://twitter.com/cryptoflipteam" target="_blank" style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;color:#000000;display:block;width:100%;">
...
//                               <td align="left" valign="middle" width="52" style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;">
//                                 <a href="https://t.me/cryptoflipchat" target="_blank" style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;color:#000000;display:block;width:100%;">
...
//                               <td width="24" style="width: 24px;line-height: 0px;font-size: 0px;border-collapse: collapse;">&nbsp;</td>
//                               <td style="font-size: 0;line-height: 0;border-collapse: collapse;">
//                                 <div style="text-align:left !important; color: #646464; font-size: 12px; font-weight: 300 !important; line-height: 12px;">Sent by CryptoFlip | Suite 23 Portland House, Glacis Road Gibraltar</div>
//                               </td>
//                               <td width="24" style="width: 24px;line-height: 0px;font-size: 0px;border-collapse: collapse;">&nbsp;</td>
//                             </tr>
//                             <tr>
